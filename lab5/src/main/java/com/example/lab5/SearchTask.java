...
public class SearchTask extends Task<List<Repo>> {
    ...
    public void resetSearchParametrs(@Nullable String searchString)
    {
        if(searchString!=null) this.searchString = searchString;
        this.page = 0;
    }
    ...
    private String search() throws Exception {
        ...
        Request request = new Request.Builder()
                .url("https://api.github.com/search/repositories?q=" + searchString  + "&page=" + page + "&per_page=20")
                .build();
