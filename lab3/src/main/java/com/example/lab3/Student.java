...
public class Student implements Parcelable {
    ...
    public Student(@NonNull String firstName, @NonNull String secondName, @NonNull String lastName, @NonNull Group group) {
    ...
    public void writeToParcel(Parcel dest, int flags) {
        ...
        dest.writeString(group.groupName);
    }
    ...
    @Override
    public int hashCode() {
        return ObjectsCompat.hash(lastName, firstName, secondName, group.groupName);
    }
